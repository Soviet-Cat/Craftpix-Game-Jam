...
// include: C:\Users\harri\AppData\Local\Temp\tmplcx28eaj.js
...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "cyberswitch.data";
    var REMOTE_PACKAGE_BASE = "cyberswitch.data";
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_cyberswitch.data");
      }
      Module["addRunDependency"]("datafile_cyberswitch.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/CyberpunkCraftpixPixel.otf",
      "start": 0,
      "end": 7704
    }, {
...
// end include: C:\Users\harri\AppData\Local\Temp\tmplcx28eaj.js
// include: C:\Users\harri\AppData\Local\Temp\tmp3flbjx7a.js
...
// end include: C:\Users\harri\AppData\Local\Temp\tmp3flbjx7a.js
// include: C:\Users\harri\AppData\Local\Temp\tmpx53ovpz9.js
...
// end include: C:\Users\harri\AppData\Local\Temp\tmpx53ovpz9.js
var arguments_ = [];
...
function writeStackCookie() {
  ...
  // ever overwritten.
  _asan_js_store(HEAPU32, ((max) >> 2), 34821223);
  _asan_js_store(HEAPU32, (((max) + (4)) >> 2), 2310721022);
}
...
function checkStackCookie() {
  ...
  var cookie1 = _asan_js_load(HEAPU32, ((max) >> 2));
  var cookie2 = _asan_js_load(HEAPU32, (((max) + (4)) >> 2));
...
function findWasmBinary() {
  return locateFile("cyberswitch.wasm");
}
...
/**
  ...
  switch (type) {
   ...
   case "i16":
    return _asan_js_load(HEAP16, ((ptr) >> 1));

   case "i32":
    return _asan_js_load(HEAP32, ((ptr) >> 2));

   case "i64":
    return _asan_js_load(HEAP64, ((ptr) >> 3));

   case "float":
    return _asan_js_load(HEAPF32, ((ptr) >> 2));

   case "double":
    return _asan_js_load(HEAPF64, ((ptr) >> 3));

   case "*":
    return _asan_js_load(HEAPU32, ((ptr) >> 2));
...
/**
  ...
  switch (type) {
   case "i1":
    _asan_js_store(HEAP8, ptr, value);
    break;
   ...
   case "i16":
    _asan_js_store(HEAP16, ((ptr) >> 1), value);
    break;

   case "i32":
    _asan_js_store(HEAP32, ((ptr) >> 2), value);
    break;

   case "i64":
    _asan_js_store(HEAP64, ((ptr) >> 3), BigInt(value));
    break;

   case "float":
    _asan_js_store(HEAPF32, ((ptr) >> 2), value);
    break;

   case "double":
    _asan_js_store(HEAPF64, ((ptr) >> 3), value);
    break;

   case "*":
    _asan_js_store(HEAPU32, ((ptr) >> 2), value);
    break;
...
var SYSCALLS = {
  ...
  writeStat(buf, stat) {
    _asan_js_store(HEAP32, ((buf) >> 2), stat.dev);
    _asan_js_store(HEAP32, (((buf) + (4)) >> 2), stat.mode);
    _asan_js_store(HEAPU32, (((buf) + (8)) >> 2), stat.nlink);
    _asan_js_store(HEAP32, (((buf) + (12)) >> 2), stat.uid);
    _asan_js_store(HEAP32, (((buf) + (16)) >> 2), stat.gid);
    _asan_js_store(HEAP32, (((buf) + (20)) >> 2), stat.rdev);
    _asan_js_store(HEAP64, (((buf) + (24)) >> 3), BigInt(stat.size));
    _asan_js_store(HEAP32, (((buf) + (32)) >> 2), 4096);
    _asan_js_store(HEAP32, (((buf) + (36)) >> 2), stat.blocks);
    var atime = stat.atime.getTime();
    var mtime = stat.mtime.getTime();
    var ctime = stat.ctime.getTime();
    _asan_js_store(HEAP64, (((buf) + (40)) >> 3), BigInt(Math.floor(atime / 1e3)));
    _asan_js_store(HEAPU32, (((buf) + (48)) >> 2), (atime % 1e3) * 1e3 * 1e3);
    _asan_js_store(HEAP64, (((buf) + (56)) >> 3), BigInt(Math.floor(mtime / 1e3)));
    _asan_js_store(HEAPU32, (((buf) + (64)) >> 2), (mtime % 1e3) * 1e3 * 1e3);
    _asan_js_store(HEAP64, (((buf) + (72)) >> 3), BigInt(Math.floor(ctime / 1e3)));
    _asan_js_store(HEAPU32, (((buf) + (80)) >> 2), (ctime % 1e3) * 1e3 * 1e3);
    _asan_js_store(HEAP64, (((buf) + (88)) >> 3), BigInt(stat.ino));
    return 0;
  },
  writeStatFs(buf, stats) {
    _asan_js_store(HEAP32, (((buf) + (4)) >> 2), stats.bsize);
    _asan_js_store(HEAP32, (((buf) + (40)) >> 2), stats.bsize);
    _asan_js_store(HEAP32, (((buf) + (8)) >> 2), stats.blocks);
    _asan_js_store(HEAP32, (((buf) + (12)) >> 2), stats.bfree);
    _asan_js_store(HEAP32, (((buf) + (16)) >> 2), stats.bavail);
    _asan_js_store(HEAP32, (((buf) + (20)) >> 2), stats.files);
    _asan_js_store(HEAP32, (((buf) + (24)) >> 2), stats.ffree);
    _asan_js_store(HEAP32, (((buf) + (28)) >> 2), stats.fsid);
    _asan_js_store(HEAP32, (((buf) + (44)) >> 2), stats.flags);
    // ST_NOSUID
    _asan_js_store(HEAP32, (((buf) + (36)) >> 2), stats.namelen);
  },
...
/** @suppress {duplicate } */ var syscallGetVarargI = () => {
  ...
  var ret = _asan_js_load(HEAP32, ((+SYSCALLS.varargs) >> 2));
  SYSCALLS.varargs += 4;
  return ret;
};
     ...
     case 12:
      {
        ...
        _asan_js_store(HEAP16, (((arg) + (offset)) >> 1), 2);
        return 0;
      }
     ...
     case 21505:
      {
        ...
        if (stream.tty.ops.ioctl_tcgets) {
          ...
          _asan_js_store(HEAP32, ((argp) >> 2), termios.c_iflag || 0);
          _asan_js_store(HEAP32, (((argp) + (4)) >> 2), termios.c_oflag || 0);
          _asan_js_store(HEAP32, (((argp) + (8)) >> 2), termios.c_cflag || 0);
          _asan_js_store(HEAP32, (((argp) + (12)) >> 2), termios.c_lflag || 0);
          for (var i = 0; i < 32; i++) {
            _asan_js_store(HEAP8, (argp + i) + (17), termios.c_cc[i] || 0);
          }
          return 0;
        }
        return 0;
     ...
     case 21508:
      {
        ...
        if (stream.tty.ops.ioctl_tcsets) {
          var argp = syscallGetVarargP();
          var c_iflag = _asan_js_load(HEAP32, ((argp) >> 2));
          var c_oflag = _asan_js_load(HEAP32, (((argp) + (4)) >> 2));
          var c_cflag = _asan_js_load(HEAP32, (((argp) + (8)) >> 2));
          var c_lflag = _asan_js_load(HEAP32, (((argp) + (12)) >> 2));
          var c_cc = [];
          for (var i = 0; i < 32; i++) {
            c_cc.push(_asan_js_load(HEAP8, (argp + i) + (17)));
          }
     ...
     case 21519:
      {
        if (!stream.tty) return -59;
        var argp = syscallGetVarargP();
        _asan_js_store(HEAP32, ((argp) >> 2), 0);
        return 0;
      }
     ...
     case 21523:
      {
        ...
        if (stream.tty.ops.ioctl_tiocgwinsz) {
          ...
          var argp = syscallGetVarargP();
          _asan_js_store(HEAP16, ((argp) >> 1), winsize[0]);
          _asan_js_store(HEAP16, (((argp) + (2)) >> 1), winsize[1]);
        }
        return 0;
      }
...
var getExceptionMessageCommon = ptr => {
  ...
  var type_addr = _asan_js_load(HEAPU32, ((type_addr_addr) >> 2));
  var message_addr = _asan_js_load(HEAPU32, ((message_addr_addr) >> 2));
...
function __mmap_js(len, prot, flags, fd, offset, allocated, addr) {
  ...
  try {
    ...
    var ptr = res.ptr;
    _asan_js_store(HEAP32, ((allocated) >> 2), res.allocated);
    _asan_js_store(HEAPU32, ((addr) >> 2), ptr);
    return 0;
  } catch (e) {
    if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
    return -e.errno;
...
var __tzset_js = (timezone, daylight, std_name, dst_name) => {
  ...
  _asan_js_store(HEAPU32, ((timezone) >> 2), stdTimezoneOffset * 60);
  _asan_js_store(HEAP32, ((daylight) >> 2), Number(winterOffset != summerOffset));
...
function _clock_time_get(clk_id, ignored_precision, ptime) {
  ...
  _asan_js_store(HEAP64, ((ptime) >> 3), BigInt(nsec));
  return 0;
}
...
var Browser = {
  ...
  setFullscreenCanvasSize() {
    ...
    if (typeof SDL != "undefined") {
      var flags = _asan_js_load(HEAPU32, ((SDL.screen) >> 2));
      flags = flags | 8388608;
      // set SDL_FULLSCREEN flag
      _asan_js_store(HEAP32, ((SDL.screen) >> 2), flags);
    }
...
var EGL = {
  ...
  chooseConfig(display, attribList, config, config_size, numConfigs) {
    ...
    if (attribList) {
      ...
      for (;;) {
        var param = _asan_js_load(HEAP32, ((attribList) >> 2));
        if (param == 12321) {
          var alphaSize = _asan_js_load(HEAP32, (((attribList) + (4)) >> 2));
          EGL.contextAttributes.alpha = (alphaSize > 0);
        } else if (param == 12325) {
          var depthSize = _asan_js_load(HEAP32, (((attribList) + (4)) >> 2));
          EGL.contextAttributes.depth = (depthSize > 0);
        } else if (param == 12326) {
          var stencilSize = _asan_js_load(HEAP32, (((attribList) + (4)) >> 2));
          EGL.contextAttributes.stencil = (stencilSize > 0);
        } else if (param == 12337) {
          var samples = _asan_js_load(HEAP32, (((attribList) + (4)) >> 2));
          EGL.contextAttributes.antialias = (samples > 0);
        } else if (param == 12338) {
          var samples = _asan_js_load(HEAP32, (((attribList) + (4)) >> 2));
          EGL.contextAttributes.antialias = (samples == 1);
        } else if (param == 12544) {
          var requestedPriority = _asan_js_load(HEAP32, (((attribList) + (4)) >> 2));
    ...
    if (numConfigs) {
      _asan_js_store(HEAP32, ((numConfigs) >> 2), 1);
    }
    if (config && config_size > 0) {
      _asan_js_store(HEAPU32, ((config) >> 2), 62002);
    }
...
var GL = {
  ...
  genObject: (n, buffers, createFunction, objectTable) => {
    for (var i = 0; i < n; i++) {
      ...
      _asan_js_store(HEAP32, (((buffers) + (i * 4)) >> 2), id);
    }
  },
  ...
  getSource: (shader, count, string, length) => {
    ...
    for (var i = 0; i < count; ++i) {
      var len = length ? _asan_js_load(HEAPU32, (((length) + (i * 4)) >> 2)) : undefined;
      source += UTF8ToString(_asan_js_load(HEAPU32, (((string) + (i * 4)) >> 2)), len);
    }
    return source;
  },
...
var _eglCreateContext = (display, config, hmm, contextAttribs) => {
  ...
  for (;;) {
    var param = _asan_js_load(HEAP32, ((contextAttribs) >> 2));
    if (param == 12440) {
      glesContextVersion = _asan_js_load(HEAP32, (((contextAttribs) + (4)) >> 2));
    } else if (param == 12344) {
      break;
    } else {
...
var _eglGetConfigAttrib = (display, config, attribute, value) => {
  ...
  switch (attribute) {
   case 12320:
    // EGL_BUFFER_SIZE
    _asan_js_store(HEAP32, ((value) >> 2), EGL.contextAttributes.alpha ? 32 : 24);
    return 1;

   case 12321:
    // EGL_ALPHA_SIZE
    _asan_js_store(HEAP32, ((value) >> 2), EGL.contextAttributes.alpha ? 8 : 0);
    return 1;

   case 12322:
    // EGL_BLUE_SIZE
    _asan_js_store(HEAP32, ((value) >> 2), 8);
    return 1;
   ...
   case 12325:
    // EGL_DEPTH_SIZE
    _asan_js_store(HEAP32, ((value) >> 2), EGL.contextAttributes.depth ? 24 : 0);
    return 1;

   case 12326:
    // EGL_STENCIL_SIZE
    _asan_js_store(HEAP32, ((value) >> 2), EGL.contextAttributes.stencil ? 8 : 0);
    return 1;

   case 12327:
    // EGL_CONFIG_CAVEAT
    // We can return here one of EGL_NONE (0x3038), EGL_SLOW_CONFIG (0x3050) or EGL_NON_CONFORMANT_CONFIG (0x3051).
    _asan_js_store(HEAP32, ((value) >> 2), 12344);
    return 1;

   case 12328:
    // EGL_CONFIG_ID
    _asan_js_store(HEAP32, ((value) >> 2), 62002);
    return 1;

   case 12329:
    // EGL_LEVEL
    _asan_js_store(HEAP32, ((value) >> 2), 0);
    return 1;

   case 12330:
    // EGL_MAX_PBUFFER_HEIGHT
    _asan_js_store(HEAP32, ((value) >> 2), 4096);
    return 1;

   case 12331:
    // EGL_MAX_PBUFFER_PIXELS
    _asan_js_store(HEAP32, ((value) >> 2), 16777216);
    return 1;
   ...
   case 12337:
    // EGL_SAMPLES
    _asan_js_store(HEAP32, ((value) >> 2), EGL.contextAttributes.antialias ? 4 : 0);
    return 1;

   case 12338:
    // EGL_SAMPLE_BUFFERS
    _asan_js_store(HEAP32, ((value) >> 2), EGL.contextAttributes.antialias ? 1 : 0);
    return 1;

   case 12339:
    // EGL_SURFACE_TYPE
    _asan_js_store(HEAP32, ((value) >> 2), 4);
    return 1;
   ...
   // EGL_TRANSPARENT_GREEN_VALUE
    ...
    _asan_js_store(HEAP32, ((value) >> 2), -1);
    return 1;
   ...
   case 12351:
    ...
    _asan_js_store(HEAP32, ((value) >> 2), 12430);
    return 1;
...
var _eglInitialize = (display, majorVersion, minorVersion) => {
  ...
  if (majorVersion) {
    _asan_js_store(HEAP32, ((majorVersion) >> 2), 1);
  }
  if (minorVersion) {
    _asan_js_store(HEAP32, ((minorVersion) >> 2), 4);
  }
...
var _eglQueryString = (display, name) => withBuiltinMalloc(() => {
  if (display != 62e3) {
    EGL.setErrorCode(12296);
    return 0;
  }
...
var readEmAsmArgs = (sigPtr, buf) => {
  ...
  // index into HEAP32.
  while (ch = _asan_js_load(HEAPU8, sigPtr++)) {
    ...
    ch == 112 ? _asan_js_load(HEAPU32, ((buf) >> 2)) : ch == 106 ? _asan_js_load(HEAP64, ((buf) >> 3)) : ch == 105 ? _asan_js_load(HEAP32, ((buf) >> 2)) : _asan_js_load(HEAPF64, ((buf) >> 3)));
    buf += wide ? 8 : 4;
  }
...
var _emscripten_get_canvas_element_size = (target, width, height) => {
  ...
  if (!canvas) return -4;
  _asan_js_store(HEAP32, ((width) >> 2), canvas.width);
  _asan_js_store(HEAP32, ((height) >> 2), canvas.height);
};
...
var getCanvasElementSize = target => {
  ...
  var size = [ _asan_js_load(HEAP32, ((w) >> 2)), _asan_js_load(HEAP32, ((h) >> 2)) ];
  stackRestore(sp);
  return size;
};
...
var _emscripten_get_element_css_size = (target, width, height) => {
  ...
  if (!target) return -4;
  var rect = getBoundingClientRect(target);
  _asan_js_store(HEAPF64, ((width) >> 3), rect.width);
  _asan_js_store(HEAPF64, ((height) >> 3), rect.height);
  return 0;
};

var fillGamepadEventData = (eventStruct, e) => {
  _asan_js_store(HEAPF64, ((eventStruct) >> 3), e.timestamp);
  for (var i = 0; i < e.axes.length; ++i) {
    _asan_js_store(HEAPF64, (((eventStruct + i * 8) + (16)) >> 3), e.axes[i]);
  }
  for (var i = 0; i < e.buttons.length; ++i) {
    if (typeof e.buttons[i] == "object") {
      _asan_js_store(HEAPF64, (((eventStruct + i * 8) + (528)) >> 3), e.buttons[i].value);
    } else {
      _asan_js_store(HEAPF64, (((eventStruct + i * 8) + (528)) >> 3), e.buttons[i]);
    }
  }
  for (var i = 0; i < e.buttons.length; ++i) {
    if (typeof e.buttons[i] == "object") {
      _asan_js_store(HEAP8, (eventStruct + i) + (1040), e.buttons[i].pressed);
    } else {
      // Assigning a boolean to HEAP32, that's ok, but Closure would like to warn about it:
      /** @suppress {checkTypes} */ _asan_js_store(HEAP8, (eventStruct + i) + (1040), e.buttons[i] == 1);
    }
  }
  _asan_js_store(HEAP8, (eventStruct) + (1104), e.connected);
  _asan_js_store(HEAP32, (((eventStruct) + (1108)) >> 2), e.index);
  _asan_js_store(HEAP32, (((eventStruct) + (8)) >> 2), e.axes.length);
  _asan_js_store(HEAP32, (((eventStruct) + (12)) >> 2), e.buttons.length);
...
var getPreloadedImageData = (path, w, h) => {
  ...
  _asan_js_store(HEAP32, ((w) >> 2), canvas.width);
  _asan_js_store(HEAP32, ((h) >> 2), canvas.height);
  return buf;
};
...
var _emscripten_get_screen_size = (width, height) => {
  _asan_js_store(HEAP32, ((width) >> 2), screen.width);
  _asan_js_store(HEAP32, ((height) >> 2), screen.height);
};
...
/** @suppress {duplicate } */ var _glDeleteBuffers = (n, buffers) => {
  for (var i = 0; i < n; i++) {
    var id = _asan_js_load(HEAP32, (((buffers) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDeleteFramebuffers = (n, framebuffers) => {
  for (var i = 0; i < n; ++i) {
    var id = _asan_js_load(HEAP32, (((framebuffers) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDeleteQueries = (n, ids) => {
  for (var i = 0; i < n; i++) {
    var id = _asan_js_load(HEAP32, (((ids) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDeleteRenderbuffers = (n, renderbuffers) => {
  for (var i = 0; i < n; i++) {
    var id = _asan_js_load(HEAP32, (((renderbuffers) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDeleteSamplers = (n, samplers) => {
  for (var i = 0; i < n; i++) {
    var id = _asan_js_load(HEAP32, (((samplers) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDeleteTextures = (n, textures) => {
  for (var i = 0; i < n; i++) {
    var id = _asan_js_load(HEAP32, (((textures) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDeleteVertexArrays = (n, vaos) => {
  for (var i = 0; i < n; i++) {
    var id = _asan_js_load(HEAP32, (((vaos) + (i * 4)) >> 2));
...
/** @suppress {duplicate } */ var _glDrawBuffers = (n, bufs) => {
  ...
  for (var i = 0; i < n; i++) {
    bufArray[i] = _asan_js_load(HEAP32, (((bufs) + (i * 4)) >> 2));
  }
...
/** @suppress {duplicate } */ var _glGenQueriesEXT = (n, ids) => {
  for (var i = 0; i < n; i++) {
    ...
    if (!query) {
      GL.recordError(1282);
      while (i < n) _asan_js_store(HEAP32, (((ids) + (i++ * 4)) >> 2), 0);
      return;
    }
    var id = GL.getNewId(GL.queries);
    query.name = id;
    GL.queries[id] = query;
    _asan_js_store(HEAP32, (((ids) + (i * 4)) >> 2), id);
  }
};
...
var __glGetActiveAttribOrUniform = (funcName, program, index, bufSize, length, size, type, name) => {
  ...
  if (info) {
    ...
    if (length) _asan_js_store(HEAP32, ((length) >> 2), numBytesWrittenExclNull);
    if (size) _asan_js_store(HEAP32, ((size) >> 2), info.size);
    if (type) _asan_js_store(HEAP32, ((type) >> 2), info.type);
  }
};
...
/** @suppress {duplicate } */ var _glGetActiveUniformBlockName = (program, uniformBlockIndex, bufSize, length, uniformBlockName) => {
  ...
  if (uniformBlockName && bufSize > 0) {
    ...
    if (length) _asan_js_store(HEAP32, ((length) >> 2), 0);
  }
};
...
/** @suppress {duplicate } */ var _glGetActiveUniformBlockiv = (program, uniformBlockIndex, pname, params) => {
  ...
  if (pname == 35393) {
    ...
    _asan_js_store(HEAP32, ((params) >> 2), name.length + 1);
    return;
  }
  ...
  if (pname == 35395) {
    for (var i = 0; i < result.length; i++) {
      _asan_js_store(HEAP32, (((params) + (i * 4)) >> 2), result[i]);
    }
  } else {
    _asan_js_store(HEAP32, ((params) >> 2), result);
  }
};
...
/** @suppress {duplicate } */ var _glGetActiveUniformsiv = (program, uniformCount, uniformIndices, pname, params) => {
  ...
  for (var i = 0; i < uniformCount; i++) {
    ids.push(_asan_js_load(HEAP32, (((uniformIndices) + (i * 4)) >> 2)));
  }
...
/** @suppress {duplicate } */ var _glGetAttachedShaders = (program, maxCount, count, shaders) => {
  ...
  _asan_js_store(HEAP32, ((count) >> 2), len);
  for (var i = 0; i < len; ++i) {
    var id = GL.shaders.indexOf(result[i]);
    _asan_js_store(HEAP32, (((shaders) + (i * 4)) >> 2), id);
  }
};
...
var readI53FromI64 = ptr => _asan_js_load(HEAPU32, ((ptr) >> 2)) + _asan_js_load(HEAP32, (((ptr) + (4)) >> 2)) * 4294967296;

var readI53FromU64 = ptr => _asan_js_load(HEAPU32, ((ptr) >> 2)) + _asan_js_load(HEAPU32, (((ptr) + (4)) >> 2)) * 4294967296;

var writeI53ToI64 = (ptr, num) => {
  _asan_js_store(HEAPU32, ((ptr) >> 2), num);
  var lower = _asan_js_load(HEAPU32, ((ptr) >> 2));
  _asan_js_store(HEAPU32, (((ptr) + (4)) >> 2), (num - lower) / 4294967296);
  var deserialized = (num >= 0) ? readI53FromU64(ptr) : readI53FromI64(ptr);
  var offset = ((ptr) >> 2);
  if (deserialized != num) warnOnce(`writeI53ToI64() out of range: serialized JS Number ${num} to Wasm heap as bytes lo=${ptrToString(_asan_js_load(HEAPU32, offset))}, hi=${ptrToString(_asan_js_load(HEAPU32, offset + 1))}, which deserializes back to ${deserialized} instead!`);
};
...
var emscriptenWebGLGet = (name_, p, type) => {
     ...
     case "object":
      if (result === null) {
        ...
        for (var i = 0; i < result.length; ++i) {
          switch (type) {
           case 0:
            _asan_js_store(HEAP32, (((p) + (i * 4)) >> 2), result[i]);
            break;

           case 2:
            _asan_js_store(HEAPF32, (((p) + (i * 4)) >> 2), result[i]);
            break;

           case 4:
            _asan_js_store(HEAP8, (p) + (i), result[i] ? 1 : 0);
            break;
          }
        }
        return;
  ...
  switch (type) {
   ...
   case 0:
    _asan_js_store(HEAP32, ((p) >> 2), ret);
    break;

   case 2:
    _asan_js_store(HEAPF32, ((p) >> 2), ret);
    break;

   case 4:
    _asan_js_store(HEAP8, p, ret ? 1 : 0);
    break;
  }
};
...
/** @suppress {duplicate } */ var _glGetBufferParameteriv = (target, value, data) => {
  ...
  _asan_js_store(HEAP32, ((data) >> 2), GLctx.getBufferParameter(target, value));
};
...
/** @suppress {duplicate } */ var _glGetBufferPointerv = (target, pname, params) => {
  if (pname == 35005) {
    ...
    _asan_js_store(HEAP32, ((params) >> 2), ptr);
  } else {
    GL.recordError(1280);
...
var emscriptenWebGLGetIndexed = (target, index, data, type) => {
  ...
  switch (type) {
   ...
   case 0:
    _asan_js_store(HEAP32, ((data) >> 2), ret);
    break;

   case 2:
    _asan_js_store(HEAPF32, ((data) >> 2), ret);
    break;

   case 4:
    _asan_js_store(HEAP8, data, ret ? 1 : 0);
    break;
...
/** @suppress {duplicate } */ var _glGetInternalformativ = (target, internalformat, pname, bufSize, params) => {
  ...
  for (var i = 0; i < ret.length && i < bufSize; ++i) {
    _asan_js_store(HEAP32, (((params) + (i * 4)) >> 2), ret[i]);
  }
};
...
/** @suppress {duplicate } */ var _glGetProgramiv = (program, pname, p) => {
  ...
  if (pname == 35716) {
    ...
    if (log === null) log = "(unknown error)";
    _asan_js_store(HEAP32, ((p) >> 2), log.length + 1);
  } else if (pname == 35719) {
    ...
    _asan_js_store(HEAP32, ((p) >> 2), program.maxUniformLength);
  } else if (pname == 35722) {
    ...
    _asan_js_store(HEAP32, ((p) >> 2), program.maxAttributeLength);
  } else if (pname == 35381) {
    ...
    _asan_js_store(HEAP32, ((p) >> 2), program.maxUniformBlockNameLength);
  } else {
    _asan_js_store(HEAP32, ((p) >> 2), GLctx.getProgramParameter(program, pname));
  }
};
...
/** @suppress {duplicate } */ var _glGetQueryObjectivEXT = (id, pname, params) => {
  ...
  _asan_js_store(HEAP32, ((params) >> 2), ret);
};
...
/** @suppress {duplicate } */ var _glGetQueryiv = (target, pname, params) => {
  ...
  _asan_js_store(HEAP32, ((params) >> 2), GLctx.getQuery(target, pname));
};
...
/** @suppress {duplicate } */ var _glGetQueryivEXT = (target, pname, params) => {
  ...
  _asan_js_store(HEAP32, ((params) >> 2), GLctx.disjointTimerQueryExt["getQueryEXT"](target, pname));
};
...
/** @suppress {duplicate } */ var _glGetRenderbufferParameteriv = (target, pname, params) => {
  ...
  _asan_js_store(HEAP32, ((params) >> 2), GLctx.getRenderbufferParameter(target, pname));
};
...
/** @suppress {duplicate } */ var _glGetSamplerParameterfv = (sampler, pname, params) => {
  ...
  _asan_js_store(HEAPF32, ((params) >> 2), GLctx.getSamplerParameter(GL.samplers[sampler], pname));
};
...
/** @suppress {duplicate } */ var _glGetSamplerParameteriv = (sampler, pname, params) => {
  ...
  _asan_js_store(HEAP32, ((params) >> 2), GLctx.getSamplerParameter(GL.samplers[sampler], pname));
};
...
/** @suppress {duplicate } */ var _glGetShaderPrecisionFormat = (shaderType, precisionType, range, precision) => {
  ...
  _asan_js_store(HEAP32, ((range) >> 2), result.rangeMin);
  _asan_js_store(HEAP32, (((range) + (4)) >> 2), result.rangeMax);
  _asan_js_store(HEAP32, ((precision) >> 2), result.precision);
};
...
/** @suppress {duplicate } */ var _glGetShaderiv = (shader, pname, p) => {
  ...
  if (pname == 35716) {
    ...
    _asan_js_store(HEAP32, ((p) >> 2), logLength);
  } else if (pname == 35720) {
    ...
    _asan_js_store(HEAP32, ((p) >> 2), sourceLength);
  } else {
    _asan_js_store(HEAP32, ((p) >> 2), GLctx.getShaderParameter(GL.shaders[shader], pname));
  }
};

var _emscripten_glGetShaderiv = _glGetShaderiv;

/** @suppress {duplicate } */ var _glGetString = name_ => withBuiltinMalloc(() => {
...
/** @suppress {duplicate } */ var _glGetSynciv = (sync, pname, bufSize, length, values) => {
  ...
  if (ret !== null) {
    _asan_js_store(HEAP32, ((values) >> 2), ret);
    if (length) _asan_js_store(HEAP32, ((length) >> 2), 1);
  }
};
...
/** @suppress {duplicate } */ var _glGetTexParameterfv = (target, pname, params) => {
  ...
  _asan_js_store(HEAPF32, ((params) >> 2), GLctx.getTexParameter(target, pname));
};
...
/** @suppress {duplicate } */ var _glGetTexParameteriv = (target, pname, params) => {
  ...
  _asan_js_store(HEAP32, ((params) >> 2), GLctx.getTexParameter(target, pname));
};
...
/** @suppress {duplicate } */ var _glGetUniformIndices = (program, uniformCount, uniformNames, uniformIndices) => {
  ...
  program = GL.programs[program];
  var names = [];
  for (var i = 0; i < uniformCount; i++) names.push(UTF8ToString(_asan_js_load(HEAP32, (((uniformNames) + (i * 4)) >> 2))));
  var result = GLctx.getUniformIndices(program, names);
  if (!result) return;
  // GL spec: If an error is generated, nothing is written out to uniformIndices.
  var len = result.length;
  for (var i = 0; i < len; i++) {
    _asan_js_store(HEAP32, (((uniformIndices) + (i * 4)) >> 2), result[i]);
  }
};
...
/** @suppress{checkTypes} */ var emscriptenWebGLGetUniform = (program, location, params, type) => {
  ...
  if (typeof data == "number" || typeof data == "boolean") {
    switch (type) {
     case 0:
      _asan_js_store(HEAP32, ((params) >> 2), data);
      break;

     case 2:
      _asan_js_store(HEAPF32, ((params) >> 2), data);
      break;
    }
  } else {
    for (var i = 0; i < data.length; i++) {
      switch (type) {
       case 0:
        _asan_js_store(HEAP32, (((params) + (i * 4)) >> 2), data[i]);
        break;

       case 2:
        _asan_js_store(HEAPF32, (((params) + (i * 4)) >> 2), data[i]);
        break;
      }
    }
  }
...
/** @suppress{checkTypes} */ var emscriptenWebGLGetVertexAttrib = (index, pname, params, type) => {
  ...
  if (pname == 34975) {
    _asan_js_store(HEAP32, ((params) >> 2), data && data["name"]);
    ...
    switch (type) {
     ...
     case 5:
      _asan_js_store(HEAP32, ((params) >> 2), Math.fround(data));
      break;
    }
  } else {
    for (var i = 0; i < data.length; i++) {
      switch (type) {
       ...
       case 5:
        _asan_js_store(HEAP32, (((params) + (i * 4)) >> 2), Math.fround(data[i]));
        break;
      }
    }
  }
...
/** @suppress {duplicate } */ var _glGetVertexAttribPointerv = (index, pname, pointer) => {
  ...
  _asan_js_store(HEAP32, ((pointer) >> 2), GLctx.getVertexAttribOffset(index, pname));
};
...
/** @suppress {duplicate } */ var _glInvalidateFramebuffer = (target, numAttachments, attachments) => {
  ...
  for (var i = 0; i < numAttachments; i++) {
    list[i] = _asan_js_load(HEAP32, (((attachments) + (i * 4)) >> 2));
  }
...
/** @suppress {duplicate } */ var _glSamplerParameterfv = (sampler, pname, params) => {
  var param = _asan_js_load(HEAPF32, ((params) >> 2));
  GLctx.samplerParameterf(GL.samplers[sampler], pname, param);
};
...
/** @suppress {duplicate } */ var _glSamplerParameteriv = (sampler, pname, params) => {
  var param = _asan_js_load(HEAP32, ((params) >> 2));
  GLctx.samplerParameteri(GL.samplers[sampler], pname, param);
};
...
/** @suppress {duplicate } */ var _glTransformFeedbackVaryings = (program, count, varyings, bufferMode) => {
  program = GL.programs[program];
  var vars = [];
  for (var i = 0; i < count; i++) vars.push(UTF8ToString(_asan_js_load(HEAP32, (((varyings) + (i * 4)) >> 2))));
...
/** @suppress {duplicate } */ var _glVertexAttrib1fv = (index, v) => {
  GLctx.vertexAttrib1f(index, _asan_js_load(HEAPF32, v >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttrib2fv = (index, v) => {
  GLctx.vertexAttrib2f(index, _asan_js_load(HEAPF32, v >> 2), _asan_js_load(HEAPF32, v + 4 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttrib3fv = (index, v) => {
  GLctx.vertexAttrib3f(index, _asan_js_load(HEAPF32, v >> 2), _asan_js_load(HEAPF32, v + 4 >> 2), _asan_js_load(HEAPF32, v + 8 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttrib4fv = (index, v) => {
  GLctx.vertexAttrib4f(index, _asan_js_load(HEAPF32, v >> 2), _asan_js_load(HEAPF32, v + 4 >> 2), _asan_js_load(HEAPF32, v + 8 >> 2), _asan_js_load(HEAPF32, v + 12 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttribI4iv = (index, v) => {
  GLctx.vertexAttribI4i(index, _asan_js_load(HEAP32, v >> 2), _asan_js_load(HEAP32, v + 4 >> 2), _asan_js_load(HEAP32, v + 8 >> 2), _asan_js_load(HEAP32, v + 12 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttribI4uiv = (index, v) => {
  GLctx.vertexAttribI4ui(index, _asan_js_load(HEAPU32, v >> 2), _asan_js_load(HEAPU32, v + 4 >> 2), _asan_js_load(HEAPU32, v + 8 >> 2), _asan_js_load(HEAPU32, v + 12 >> 2));
};
...
var _emscripten_request_fullscreen_strategy = (target, deferUntilInEventHandler, fullscreenStrategy) => {
  var strategy = {
    scaleMode: _asan_js_load(HEAP32, ((fullscreenStrategy) >> 2)),
    canvasResolutionScaleMode: _asan_js_load(HEAP32, (((fullscreenStrategy) + (4)) >> 2)),
    filteringMode: _asan_js_load(HEAP32, (((fullscreenStrategy) + (8)) >> 2)),
    deferUntilInEventHandler,
    canvasResizedCallback: _asan_js_load(HEAP32, (((fullscreenStrategy) + (12)) >> 2)),
    canvasResizedCallbackUserData: _asan_js_load(HEAP32, (((fullscreenStrategy) + (16)) >> 2))
  };
...
var registerFocusEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
...
var fillFullscreenChangeEventData = eventStruct => {
  ...
  /** @suppress{checkTypes} */ _asan_js_store(HEAP8, eventStruct, isFullscreen);
  _asan_js_store(HEAP8, (eventStruct) + (1), JSEvents.fullscreenEnabled());
  ...
  _asan_js_store(HEAP32, (((eventStruct) + (260)) >> 2), reportedElement ? reportedElement.clientWidth : 0);
  _asan_js_store(HEAP32, (((eventStruct) + (264)) >> 2), reportedElement ? reportedElement.clientHeight : 0);
  _asan_js_store(HEAP32, (((eventStruct) + (268)) >> 2), screen.width);
  _asan_js_store(HEAP32, (((eventStruct) + (272)) >> 2), screen.height);
  if (isFullscreen) {
    JSEvents.previousFullscreenElement = fullscreenElement;
  }
};

var registerFullscreenChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
...
var registerGamepadEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
...
var registerKeyEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
  JSEvents.keyEvent ||= _malloc(160);
  var keyEventHandlerFunc = e => {
    assert(e);
    var keyEventData = JSEvents.keyEvent;
    _asan_js_store(HEAPF64, ((keyEventData) >> 3), e.timeStamp);
    var idx = ((keyEventData) >> 2);
    _asan_js_store(HEAP32, idx + 2, e.location);
    _asan_js_store(HEAP8, keyEventData + 12, e.ctrlKey);
    _asan_js_store(HEAP8, keyEventData + 13, e.shiftKey);
    _asan_js_store(HEAP8, keyEventData + 14, e.altKey);
    _asan_js_store(HEAP8, keyEventData + 15, e.metaKey);
    _asan_js_store(HEAP8, keyEventData + 16, e.repeat);
    _asan_js_store(HEAP32, idx + 5, e.charCode);
    _asan_js_store(HEAP32, idx + 6, e.keyCode);
    _asan_js_store(HEAP32, idx + 7, e.which);
...
var fillMouseEventData = (eventStruct, e, target) => {
  ...
  _asan_js_store(HEAP32, idx + 2, e.screenX);
  _asan_js_store(HEAP32, idx + 3, e.screenY);
  _asan_js_store(HEAP32, idx + 4, e.clientX);
  _asan_js_store(HEAP32, idx + 5, e.clientY);
  _asan_js_store(HEAP8, eventStruct + 24, e.ctrlKey);
  _asan_js_store(HEAP8, eventStruct + 25, e.shiftKey);
  _asan_js_store(HEAP8, eventStruct + 26, e.altKey);
  _asan_js_store(HEAP8, eventStruct + 27, e.metaKey);
  _asan_js_store(HEAP16, idx * 2 + 14, e.button);
  _asan_js_store(HEAP16, idx * 2 + 15, e.buttons);
  _asan_js_store(HEAP32, idx + 8, e["movementX"]);
  _asan_js_store(HEAP32, idx + 9, e["movementY"]);
  // Note: rect contains doubles (truncated to placate SAFE_HEAP, which is the same behaviour when writing to HEAP32 anyway)
  var rect = getBoundingClientRect(target);
  _asan_js_store(HEAP32, idx + 10, e.clientX - (rect.left | 0));
  _asan_js_store(HEAP32, idx + 11, e.clientY - (rect.top | 0));
};
...
var fillPointerlockChangeEventData = eventStruct => {
  ...
  // Assigning a boolean to HEAP32 with expected type coercion.
  /** @suppress{checkTypes} */ _asan_js_store(HEAP8, eventStruct, isPointerlocked);
...
var registerUiEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
  ...
  var uiEventHandlerFunc = (e = event) => {
    ...
    _asan_js_store(HEAP32, ((uiEvent) >> 2), 0);
    // always zero for resize and scroll
    _asan_js_store(HEAP32, (((uiEvent) + (4)) >> 2), b.clientWidth);
    _asan_js_store(HEAP32, (((uiEvent) + (8)) >> 2), b.clientHeight);
    _asan_js_store(HEAP32, (((uiEvent) + (12)) >> 2), innerWidth);
    _asan_js_store(HEAP32, (((uiEvent) + (16)) >> 2), innerHeight);
    _asan_js_store(HEAP32, (((uiEvent) + (20)) >> 2), outerWidth);
    _asan_js_store(HEAP32, (((uiEvent) + (24)) >> 2), outerHeight);
    _asan_js_store(HEAP32, (((uiEvent) + (28)) >> 2), pageXOffset | 0);
    // scroll offsets are float
    _asan_js_store(HEAP32, (((uiEvent) + (32)) >> 2), pageYOffset | 0);
...
var registerTouchEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
  ...
  var touchEventHandlerFunc = e => {
    ...
    _asan_js_store(HEAPF64, ((touchEvent) >> 3), e.timeStamp);
    _asan_js_store(HEAP8, touchEvent + 12, e.ctrlKey);
    _asan_js_store(HEAP8, touchEvent + 13, e.shiftKey);
    _asan_js_store(HEAP8, touchEvent + 14, e.altKey);
    _asan_js_store(HEAP8, touchEvent + 15, e.metaKey);
    ...
    for (let t of Object.values(touches)) {
      ...
      _asan_js_store(HEAP32, idx32 + 0, t.identifier);
      _asan_js_store(HEAP32, idx32 + 1, t.screenX);
      _asan_js_store(HEAP32, idx32 + 2, t.screenY);
      _asan_js_store(HEAP32, idx32 + 3, t.clientX);
      _asan_js_store(HEAP32, idx32 + 4, t.clientY);
      _asan_js_store(HEAP32, idx32 + 5, t.pageX);
      _asan_js_store(HEAP32, idx32 + 6, t.pageY);
      _asan_js_store(HEAP8, idx + 28, t.isChanged);
      _asan_js_store(HEAP8, idx + 29, t.onTarget);
      _asan_js_store(HEAP32, idx32 + 8, t.clientX - (targetRect.left | 0));
      _asan_js_store(HEAP32, idx32 + 9, t.clientY - (targetRect.top | 0));
      idx += 48;
      if (++numTouches > 31) {
        break;
      }
    }
    _asan_js_store(HEAP32, (((touchEvent) + (8)) >> 2), numTouches);
...
var fillVisibilityChangeEventData = eventStruct => {
  ...
  // Assigning a boolean to HEAP32 with expected type coercion.
  /** @suppress{checkTypes} */ _asan_js_store(HEAP8, eventStruct, document.hidden);
  _asan_js_store(HEAP32, (((eventStruct) + (4)) >> 2), visibilityState);
};

var registerVisibilityChangeEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
...
var registerWheelEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => withBuiltinMalloc(() => {
  ...
  var wheelHandlerFunc = (e = event) => {
    ...
    _asan_js_store(HEAPF64, (((wheelEvent) + (64)) >> 3), e["deltaX"]);
    _asan_js_store(HEAPF64, (((wheelEvent) + (72)) >> 3), e["deltaY"]);
    _asan_js_store(HEAPF64, (((wheelEvent) + (80)) >> 3), e["deltaZ"]);
    _asan_js_store(HEAP32, (((wheelEvent) + (88)) >> 2), e["deltaMode"]);
...
var _emscripten_stack_unwind_buffer = (addr, buffer, count) => {
  ...
  for (var i = 0; i < count && stack[i + offset]; ++i) {
    _asan_js_store(HEAP32, (((buffer) + (i * 4)) >> 2), convertFrameToPC(stack[i + offset]));
  }
  return i;
};
...
var _environ_get = (__environ, environ_buf) => {
  ...
  for (var string of getEnvStrings()) {
    ...
    _asan_js_store(HEAPU32, (((__environ) + (envp)) >> 2), ptr);
...
var _environ_sizes_get = (penviron_count, penviron_buf_size) => {
  ...
  _asan_js_store(HEAPU32, ((penviron_count) >> 2), strings.length);
  var bufSize = 0;
  for (var string of strings) {
    bufSize += lengthBytesUTF8(string) + 1;
  }
  _asan_js_store(HEAPU32, ((penviron_buf_size) >> 2), bufSize);
  return 0;
};
...
/** @param {number=} offset */ var doReadv = (stream, iov, iovcnt, offset) => {
  ...
  for (var i = 0; i < iovcnt; i++) {
    var ptr = _asan_js_load(HEAPU32, ((iov) >> 2));
    var len = _asan_js_load(HEAPU32, (((iov) + (4)) >> 2));
    iov += 8;
...
function _fd_read(fd, iov, iovcnt, pnum) {
  try {
    ...
    _asan_js_store(HEAPU32, ((pnum) >> 2), num);
    return 0;
  } catch (e) {
    if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
    return e.errno;
...
function _fd_seek(fd, offset, whence, newOffset) {
  ...
  try {
    ...
    _asan_js_store(HEAP64, ((newOffset) >> 3), BigInt(stream.position));
...
var ASM_CONSTS = {
  ...
  307352792: ($0, $1) => {
    ...
    for (var c = 0; c < numChannels; ++c) {
      ...
      for (var j = 0; j < $1; ++j) {
        channelData[j] = _asan_js_load(HEAPF32, buf + (j * numChannels + c));
      }
    }
  },
  307353281: $0 => {
  ...
  307354287: ($0, $1, $2) => {
    ...
    if (typeof CanvasPixelArray !== "undefined" && data instanceof CanvasPixelArray) {
      num = data.length;
      while (dst < num) {
        var val = _asan_js_load(HEAP32, src);
        data[dst] = val & 255;
  ...
  307356895: () => window.innerWidth,
  307356925: () => window.innerHeight
};
...
function assignWasmExports(wasmExports) {
  ...
  ___asan_loadN = createExportWrapper("__asan_loadN", 2);
  ___asan_storeN = createExportWrapper("__asan_storeN", 2);
}
